...
- **CRUD dialog unification pass**: Device Groups, Groups, Tags, and Address Book Collections migrated to `DataTable` + `AppDialog` with standardized footer actions and no inline cancel/submit buttons.
- **Review/verification**:
