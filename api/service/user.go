...
// FindLatestUserIdFromLoginLogByUuid uuididid
...
// IsPasswordEmptyByUsername idпјЊ
...
// IsUsernameExists , it will check the internal database and LDAP(if enabled)
